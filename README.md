...
```bash
docker run -p 8087:8087 ghcr.io/wizrds/lockbox:0.2.0 serve --migrations
```
...
```bash
helm upgrade --install lockbox oci://ghcr.io/wizrds/lockbox/charts/lockbox --version 0.2.0
```
